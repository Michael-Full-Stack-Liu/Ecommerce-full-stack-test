...
const HeaderCategorySelector = async () => {
  ...
  return (
    <div className='relative inline-block'>
        <button type="button" className='peer group text-gray-700 hover:text-gray-900 text-sm font-medium flex items-center gap-1'>
            Categories
            <svg 
        ...
        <div className='absolute top-full left-0 pt-2  invisible  peer-hover:visible  hover:opacity-100 hover:visible transition-all duration-300'>
